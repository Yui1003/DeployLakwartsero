            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <address>
                        ...
                        <p><i class="fas fa-envelope me-2"></i>travels@lakwartsero.com</p>
                    </address>
                    <div class="newsletter">
                        <h6>Subscribe to our Newsletter</h6>
                        <div class="input-group">
                            <input type="email" class="form-control" placeholder="Your Email" required pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Please enter a valid email address">
            ...
            <div class="row footer-bottom">
                ...
                <div class="col-md-6 text-md-end">
                    <ul class="footer-bottom-links">
                        ...
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#cookieModal">Cookie Policy</a></li>
                    </ul>
                </div>
            </div>
        </div>
